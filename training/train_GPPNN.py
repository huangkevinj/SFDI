...
sys.path.append("/home/jieh/Projects/PAN_Sharp/PansharpingFourier/GPPNN/")
from models import get_sat_param
from models.GPPNN3 import GPPNN
...
net = GPPNN(channels=n_feat).to(device)
print(net)

predir = '/home/jieh/Projects/PAN_Sharp/PansharpingFourier/GPPNN/training/logs/GPPNN3/Best'
...
save_path = os.path.join(
    '/home/jieh/Projects/PAN_Sharp/PansharpingFourier/GPPNN/training/logs/%s' % (model_str),
